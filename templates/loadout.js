 ...
 * GET/POST /api/loadout only. Never starts RoArm or touches drive signs.
 */
(function () {
  'use strict';

  var ARM_OFFLINE_MESSAGE = 'arm offline — not wired on this build yet';
  var API = '/api/loadout';
  ...
  function renderStage() {
    ...
    if (banner) {
      ...
      if (selection.attachment === 'roarm2') {
        banner.textContent = ARM_OFFLINE_MESSAGE;
      }
    }
